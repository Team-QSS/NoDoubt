...
public class SignUpLevel extends GameLevel{
	...
	public SignUpLevel() {
		m_ID 		= new TextBox("fontR11", 0, 0.0f, -3.0f, -313.0f,   15.0f, false, false, "ID", new Vector3f(0, 0, 0));
		m_PW 		= new TextBox("fontR11", 0, 0.0f, -3.0f, -313.0f, -116.0f,  true, false, "PW", new Vector3f(0, 0, 0));
		m_PWRepeat 	= new TextBox("fontR11", 0, 0.0f, -3.0f, -313.0f, -240.0f,  true, false, "Retype", new Vector3f(0, 0, 0));
